...
import static dus.gpb.khabibullinfrontendbot.service.command.impl.RegisterCommand.REGISTER_COMMAND_VALUE;
...
class RegisterCommandTest {
    ...
    void When_handleCommand_with_successful_registration_than_send_success_message() {
        ...
        Message testMessage = getTestMessage(testUser, testChatId, REGISTER_COMMAND_VALUE);
