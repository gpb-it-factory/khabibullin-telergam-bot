...
public class CreateAccountCommand implements Command {
    ...
    public static final String CREATE_ACCOUNT_COMMAND_VALUE = "/createaccount";
    ...
    public String getCommandValue() {
        return CREATE_ACCOUNT_COMMAND_VALUE;
    }

    private boolean validateCommand(String text) {
        return text.split(" ").length == 1 && text.split(" ")[0].equals(CREATE_ACCOUNT_COMMAND_VALUE);
    }
